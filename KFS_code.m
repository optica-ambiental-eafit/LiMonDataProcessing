...
for file_index = 1:num_of_files
   ...
   % Time capture from files names
    ...
    alfa_aer = abs(alfa - alpha_mol(data_range));
...
if m == 1
    user_choice = menu('Choose the optical product profile you want to display: ', 'Beta aerosol CH0','Alpha aerosol CH0');
    product = {beta_aer_CH0, alpha_aer_CH0};
else if m == 3
    user_choice = menu('Choose the optical product profile you want to display: ', 'Beta aerosol CH1','Alpha aerosol CH1');
    product = {beta_aer_CH0, alpha_aer_CH0};
    end
end
...
%%%%%%%%%%%%%%%%%%%%%%%%% IMPORTANT:%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% IF YOU WISH TO PLOT BETA AND ALPHA FOR CHANNEL 1, CHANGE THE m = 1 VALUE IN LINE 62 FOR m = 2
